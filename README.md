...
| [`report/reflection_report.md`](report/reflection_report.md) | The reflection report |
...
Cash $45,059.70 → $46,242.28 (+$1,182.58) on a 29.4% net margin. All 42 recorded
sales match the price the customer was quoted, and no internal status code
reached a customer.
...
├── audit_replies.py                   <- verifies no internal vocabulary leaks
